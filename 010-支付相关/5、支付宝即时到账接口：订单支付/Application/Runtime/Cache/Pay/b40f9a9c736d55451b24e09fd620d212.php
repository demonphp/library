...
<title>购物车</title>
<script src="/Public/js/jquery-1.12.3.min.js" type="text/javascript"></script>  
</head> 
<body>
<style type="text/css">
...
<div class="gwc" style=" margin:auto;">
	...
	<table cellpadding="0" cellspacing="0" class="gwc_tb2">
		<tr>
			...
			<td class="tb1_td6"><label id="total1" class="tot" style="color:#ff5500;font-size:14px; font-weight:bold;">1.25</label></td>
			<td class="tb1_td7"><a href="#">删除</a></td>
		</tr>
	</table>
	<table cellpadding="0" cellspacing="0" class="gwc_tb3">
		<tr>
			<td id="subject" style="display:none">测试订单标题12</td>
			<td id="out_trade_no"  style="display:none">CS201640069925888</td>
			<td class="tb3_td3">合计(不含运费):<span>￥</span><span id="total_fee">1.25</span></td>
...
function payto(){
	$.ajax({
		 type: "post",
		 url: "<?php echo U('Pay/Index/payto');?>",
